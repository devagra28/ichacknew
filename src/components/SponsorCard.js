                ...
                <div key={index}>
                    <div className="flex flex-col items-center justify-around border border-gray-300 rounded-lg md:flex-row mb-4 bg-[#e3ebfa] md:p-8 mx-[1%] md:mx-[5%]">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{sponsor.sponsorName}</h5>
                            <p className="mb-3 font-normal text-gray-700 text-justify">{sponsor.sponsorAbout}</p>
                            <div className='pb-[1%]'>
                                <a href="/">
                                    <CustomButton
