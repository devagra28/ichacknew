                ...
                <div key={index}>
                    <div className="flex flex-col items-center justify-around border border-gray-300 rounded-lg md:flex-row mb-4 bg-[#e3ebfa] md:p-8 mx-[1%] md:mx-[5%]">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            <h1 className=" text-4xl font-bold tracking-tight text-gray-900 mb-[2%]">{sponsor.sponsorName}</h1>
                            <p className="mb-[2%] font-normal text-gray-500 text-2xl text-justify">{sponsor.sponsorAbout}</p>
                            <div className='pb-[1%]'>
                                <a href="/">
                                    <CustomButton
